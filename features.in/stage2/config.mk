...
# loongarch64 and riscv64 should rely on simpledrm.ko, which
# should be built into the kernel image
use/stage2/drm: use/stage2
ifneq (,$(filter-out loongarch64 riscv64,$(ARCH)))
	@$(call add,STAGE1_MODLISTS,stage2-drm)
endif
	@:
