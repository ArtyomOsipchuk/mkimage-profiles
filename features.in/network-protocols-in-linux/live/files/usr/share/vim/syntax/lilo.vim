...
" Path
syn keyword liloOption backup bitmap boot disktab force-backup keytable map message nextgroup=liloEqPathString,liloEqPathComment,liloError skipwhite skipempty
syn keyword liloKernelOpt initrd root nextgroup=liloEqPathString,liloEqPathComment,liloError skipwhite skipempty
syn keyword liloImageOpt path loader table nextgroup=liloEqPathString,liloEqPathComment,liloError skipwhite skipempty
syn keyword liloDiskOpt partition nextgroup=liloEqPathString,liloEqPathComment,liloError skipwhite skipempty
...
" Image
syn keyword liloImage image other nextgroup=liloEqPathString,liloEqPathComment,liloError skipwhite skipempty
syn keyword liloDisk disk nextgroup=liloEqPathString,liloEqPathComment,liloError skipwhite skipempty
...
syn match liloEqPathComment "#.*$" contained nextgroup=liloEqPathString,liloEqPathComment,liloError skipwhite skipempty
...
syn match liloEqPathString "=" contained nextgroup=liloString,liloPath,liloPathStringComment,liloError skipwhite skipempty
...
" Comment followed by ...
syn match liloPathStringComment "#.*$" contained nextgroup=liloString,liloPath,liloPathStringComment,liloError skipwhite skipempty
...
hi def link liloEqPathString       liloEquals
...
hi def link liloEqLabelString      liloEquals
...
hi def link liloPathStringComment  liloComment
